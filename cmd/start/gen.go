...
import (
	...
	cons "github.com/leijeng/huo-admin/common/consts"
	"github.com/leijeng/huo-admin/modules/tools/service"
...
var (
	...
	GenCmd      = &cobra.Command{
		...
		Example: "go run . gen -c resources/config.yml -d xx -t xxx",
...
func init() {
	GenCmd.PersistentFlags().StringVarP(&configYml, "config", "c", "resources/config.yml", "Start server with provided configuration file")
